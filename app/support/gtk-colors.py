...
'Menu':        menubar.style.bg[gtk.STATE_NORMAL]    ,
...
# Legacy key in regedit
f.write("""[HKEY_USERS\S-1-5-4\Control Panel]
...
# New key in regedit start from wine 1.3.15
f.write("""[HKEY_USERS\S-1-5-21-0-0-0-1000\Control Panel]
